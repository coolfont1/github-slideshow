...
Bot.editMessage("*Now send me the text that will be shown on info button.*\n"+hl+"\n\n-> _For Text Formatting use_ *HTML* _formate_",id)
Bot.runCommand("/settext01info")
}
