...
let minn=Bot.getProperty("adminminwd01")
...
var textal="💡* Your DOGE wallet is: *"+"`"+wagas+"`"
...
if(duration_in_hours<10){



var mgs='⏳ _Withdrawal Cooldown in_ *'
let kl=10-duration_in_hours
if(kl<1){
let t2= kl
let pers=100*t2
...
srbp.add(1)
var maxy = Bot.getProperty('maxwd')
maxy = maxy*1
...
bd_time:new Date().toLocaleString('en-US', {timeZone: 'Africa/Lagos'
})
,
withdrawal_info: {
wd_amount: message, 
...
address: wall,
  ...
  onSuccess: '/adminwdsuccess'+' '+wdlist2.value()
});
}
